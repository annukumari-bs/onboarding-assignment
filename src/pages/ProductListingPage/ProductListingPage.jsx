      ...
      <div className="flex flex-col md:flex-row w-full">
        <aside className="w-full md:w-1/4 lg:w-1/5 pr-0 md:pr-6 mb-8 md:mb-0">
          ...
          <form>
            ...
            <fieldset className="mb-6">
              <legend className="text-lg font-semibold mb-2">Price Range</legend>
        ...
        <main className="w-full md:w-3/4 lg:w-4/5">
          <div className="flex justify-between items-center mb-4">
            <p className="text-gray-600" aria-live="polite">{filteredAndSortedProducts.length} Products Found</p>
            <div>
          ...
          {status === 'loading' && (
            <div className="text-center py-10" role="status">Loading products...</div>
          )}

          {status === 'succeeded' && (
            <section id="product-grid" aria-live="polite" aria-atomic="true">
              ...
              {hasMoreToLoad && (
                <div className="text-center mt-8">
                  <button
                    ...
                    className="bg-white border-black border text-black px-6 py-2 hover:bg-black hover:text-white transition-all font-medium"
                  >
                    Load More Products
                  </button>
                </div>
